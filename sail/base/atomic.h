...
/* gcc version <= 4.2, __sync_synchronize is empty implement, which is a bug.
   gcc version >= 4.4, __sync_synchronize corresponds to "mfence" the assembly instructions.
   use to ensure instruction sequence
 */ 
